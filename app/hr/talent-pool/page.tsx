...
import { bestMatchJob, studentSkills } from "@/lib/hr-match";
import {
  cancelInvitation,
  inviteTalent,
  type JobWithSkills,
...
export default function TalentPoolPage() {
  const { hr, company, jobs, talents, talentGrades, invitations, prodiNames, loading, error } =
    useHRData();
  ...
  }, [talents, gradesByStudent, activeJobs, inviteByStudent, prodiNames]);
